...
public class ColorOptionsPanel extends JPanel
{
    ...
    private JRadioButton[] colorButtons = new JRadioButton[NUM_COLORS];
    // ------------------------------------------------------------------
    ...
    public ColorOptionsPanel ()
    {
        ...
        // Group the radio buttons, add a ColorListener to each,
            for(int i = 0; i < NUM_COLORS; i++) {
                colorButtons[i].setText(color[i].toString());
                colorButtons[i].addActionListener(new ColorListener());
            }
